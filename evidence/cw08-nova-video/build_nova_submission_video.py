...
def main():
    ...
    scenes = [
        ...
        scene(
            ...
            "Peer Review has no demonstrated advantage yet.",
            ...
            (
                "The separate post fix pilot tested five known conditions per method. The "
                "fixed rule baseline completed four. The single model completed three. The "
                "model with simulation completed three. Simulation with Peer Review "
                "completed four, matching the baseline. The entire batch cost about fifty "
                "two cents in reported model usage. These small known samples do not "
                "demonstrate a Peer Review advantage. Failed and impossible cases remain in "
                "every denominator."
            ),
            table=[
                ...
                *[
                    [
                        m,
                        str(pilot["methods"][m]["goal_complete"]) + "/5",
